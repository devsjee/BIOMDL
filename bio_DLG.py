...
test =text #'K_QGK_KV_YLTA_AP_Q_C#_PFPDRY_LGTALN_TGL_FD_YVWVQ_FYNNPPCQ_Y_S_SG_N_INNIINSWNRWTTS_INAG_KIFLGLP_A_APEAAGSG_YVP_PDVLISRILPEIK_K_SPK_YGGVMLW_S_KFYDDKN_G_YSSSIL_DSV@'
#test = test.replace('_','');
